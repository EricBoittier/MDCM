...
#$ -e /home/boittier/MDCM/big_basis_set/water
#$ -o /home/boittier/MDCM/big_basis_set/water
#$ -N water_opt_freq
#$ -p 0
#$ -pe smp 8
# 
...
$GAUSSIAN_EXE /home/boittier/MDCM/big_basis_set/water/water_opt_freq.com /scratch/$USER/water_opt_freq/water_opt_freq.out

# don't delete the result file if not able to copy to fileserver 
cp /scratch/$USER/water_opt_freq/water_opt_freq.out /home/boittier/MDCM/big_basis_set/water/water_opt_freq.out 
status=$?
if [ $status -eq 0 ] 
then 
...
to
	/home/boittier/MDCM/big_basis_set/water/water_opt_freq.out
