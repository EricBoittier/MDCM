...
#$ -e /home/boittier/MDCM/big_basis_set/cyanomethane
#$ -o /home/boittier/MDCM/big_basis_set/cyanomethane
...
$GAUSSIAN_EXE /home/boittier/MDCM/big_basis_set/cyanomethane/cyanomethane_opt_freq.com /scratch/$USER/cyanomethane_opt_freq/cyanomethane_opt_freq.out

# don't delete the result file if not able to copy to fileserver 
cp /scratch/$USER/cyanomethane_opt_freq/cyanomethane_opt_freq.out /home/boittier/MDCM/big_basis_set/cyanomethane/cyanomethane_opt_freq.out 
status=$?
if [ $status -eq 0 ] 
then 
...
to
	/home/boittier/MDCM/big_basis_set/cyanomethane/cyanomethane_opt_freq.out
