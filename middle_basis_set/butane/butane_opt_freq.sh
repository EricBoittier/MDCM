...
#$ -e /home/boittier/MDCM/big_basis_set/butane
#$ -o /home/boittier/MDCM/big_basis_set/butane
#$ -N butane_opt_freq
#$ -p 0
#$ -pe smp 8
# 
...
$GAUSSIAN_EXE /home/boittier/MDCM/big_basis_set/butane/butane_opt_freq.com /scratch/$USER/butane_opt_freq/butane_opt_freq.out

# don't delete the result file if not able to copy to fileserver 
cp /scratch/$USER/butane_opt_freq/butane_opt_freq.out /home/boittier/MDCM/big_basis_set/butane/butane_opt_freq.out 
status=$?
if [ $status -eq 0 ] 
then 
...
to
	/home/boittier/MDCM/big_basis_set/butane/butane_opt_freq.out
