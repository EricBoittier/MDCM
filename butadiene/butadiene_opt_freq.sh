...
#SBATCH --job-name=butadiene_opt_freq
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#set -xv
echo butadiene_opt_freq >> /home/$USER/ttjobs
mkdir -p /scratch/$USER/butadiene_opt_freq
export GAUSS_SCRDIR=/scratch/$USER/butadiene_opt_freq

$GAUSSIAN_EXE /home/boittier/MDCM/butadiene/butadiene_opt_freq.com /scratch/$USER/butadiene_opt_freq/butadiene_opt_freq.out

# don't delete the result file if not able to copy to fileserver 
cp /scratch/$USER/butadiene_opt_freq/butadiene_opt_freq.out /home/boittier/MDCM/butadiene/butadiene_opt_freq.out 
status=$?
if [ $status -eq 0 ] 
then 
...
to
	/home/boittier/MDCM/butadiene/butadiene_opt_freq.out
